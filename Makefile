...
targets = benchmark-naive benchmark-blocked benchmark-blocked-1 benchmark-blas 
objects = benchmark.o dgemm-naive.o dgemm-blocked.o dgemm-blocked-1.o dgemm-blas.o
